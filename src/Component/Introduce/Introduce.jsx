...
<div className="parent mt-[100px] text-white">
  ...
  className="mt-[30px] text-white">
    ...
    <Link href="www.linkedin.com/in/ahmed-eid-8b66682a6" className='w-[50px] group h-[50px] rounded-full border hover:bg-[#1DA1F2] flex items-center transition-all justify-center'>
      <FaLinkedin className="cursor-pointer opacity-[0.8] text-[#1DA1F2] group-hover:text-white font-bold transition-all hover:opacity-[1]" size={32} />
    </Link>

    <Link href="https://web.telegram.org/a/" className='w-[50px] group h-[50px] rounded-full border hover:bg-[#0088cc] flex items-center transition-all justify-center'>
      <FaTelegramPlane className="cursor-pointer opacity-[0.8] text-[#0088CC] group-hover:text-white transition-all hover:opacity-[1]" size={32} />
    </Link>

    <Link href="https://github.com/ahmed-elrooby" className='w-[50px] h-[50px] rounded-full border hover:bg-[#333] flex items-center transition-all justify-center'>
