...
const Footer = () => {
    return (
        <footer className='w-[90%]  z-[222] relative my-4   m-auto '>
            ...
            className='flex flex-wrap justify-around items-center text-center md:items-end  mb-[20px] gap-2 md:gap-[40px]'>
                <div>
                    <h1 className='text-[22px] text-white capitalize'>
    ...
    <FaInstagram className="cursor-pointer  transition-colors duration-300  opacity-[0.8] hover:opacity-[1]" size={32} />
        ...
        <div className='flex w-[30px] flex-col items-center gap-4 group'>
          ...
          <Link  href="https://github.com/ahmed-elrooby " className='w-[40px] h-[40px] rounded-full border hover:bg-[#333]  flex items-center transition-all justify-center'>
            <Github className="cursor-pointer transition-all opacity-[0.8] text-white hover:text-[--main-color]   hover:opacity-[1]"  size={32} />
          </Link>
        </div>
      </div>
            </motion.div>
